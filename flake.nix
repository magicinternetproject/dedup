  ...
  outputs = {
      ...
      forAllSystems = function:
        nixpkgs.lib.genAttrs [
          ...
          "aarch64-darwin"
            ...
            dedup = craneLib.buildPackage (craneCommon
              // {
    ...
    in {
      checks = forAllSystems ({
        ...
        dedup-clippy = craneLib.cargoClippy (craneCommon
          // {
            inherit cargoArtifacts;
        ...
        # Check formatting
        dedup-fmt = craneLib.cargoFmt {
          inherit src;
        };

        # Audit dependencies
        dedup-audit = craneLib.cargoAudit {
      ...
      apps = forAllSystems ({system, ...}: {
        dedup = {
          type = "app";
          program = "${self.packages.${system}.dedup}/bin/dedup";
        };
        default = self.apps.${system}.dedup;
      });
